...
# Hiển thị thông tin với hiệu ứng gõ chữ
print(Fore.YELLOW + "Thông tin liên hệ:\n" + Style.RESET_ALL)
...
def run(phone, i):
    ...
    for j in range(1, 0, -1):
        print(f"chờ đi {j} giây", end="\r")
        time.sleep(1)

if __name__ == "__main__":
    print("\033[1;34msadboiz\033[0m")  # Màu xanh dương đậm
    phone = input("Nhập số thằng chó đó vào đây: ")
