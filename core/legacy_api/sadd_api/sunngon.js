...
function predictLogic22(history, cauLogData) {
    ...
    // Sử dụng cauLogData (nếu có) – ở đây giữ logic, nhưng không dùng file log, chỉ dùng mảng rỗng.
    // Nếu muốn lưu log, có thể thêm, nhưng theo yêu cầu không lấy DB, bỏ qua.
...
server.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`\n=========================================`);
    console.log(`🚀 WORM GPT Sun.Win Data + Prediction Server (HuyDaiXu AI)`);
    console.log(`=========================================`);
